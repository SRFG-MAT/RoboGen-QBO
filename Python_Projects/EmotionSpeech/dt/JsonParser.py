...
def loadDTData(area):
    ...
    with open('/home/pi/Documents/RoboGen-QBO/Python_Projects/EmotionSpeech/dt/json/robogen_decisiontrees.json', 'r') as dt_file:
...
def loadInterventionData(codeInput):
    ...
    with open('/home/pi/Documents/RoboGen-QBO/Python_Projects/EmotionSpeech/dt/json/robogen_interventions.json', 'r') as interventions_file:
